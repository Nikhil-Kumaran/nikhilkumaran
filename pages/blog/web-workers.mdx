...
[User interface w/o web worker](https://codesandbox.io/s/user-interface-wo-web-worker-xs7pr)
...
I tried doing web worker example in [codesandbox](https://codesandbox.io/s/with-web-worker-0s3q7), but for some reason, I couldn't import the worker file(`const worker = new Worker("src/worker.js")`).
